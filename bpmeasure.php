...
<main class="content">
    ...
    <div class="entries">
        ...
        <div class="miles">Miles Walked</div>
        <div class="sodium">Sodium</div>

        <?php foreach ($bp as $entry) { ?>
            <div contenteditable="true" class="date_taken"><?php echo styleDate($entry['date_taken']); ?></div>
            <div class="systolic"><?= $entry['systolic'] ?></div>
            <div class="diastolic"><?= $entry['diastolic'] ?></div>
            <div class="pulse"><?= $entry['pulse'] ?></div>
            <div contenteditable="true"
                 class="miles"><?= ($entry['miles_walked'] != 0) ? $entry['miles_walked'] . ' miles' : null ?></div>
            <div class="sodium"><?= ($entry['sodium'] != 0) ? $entry['sodium'] : null ?></div>
        <?php } ?>
...
<div class="sidebar">
    <form class="bpForm" method="post">
        ...
        <label for="miles_walked_form">Miles Walked</label>
